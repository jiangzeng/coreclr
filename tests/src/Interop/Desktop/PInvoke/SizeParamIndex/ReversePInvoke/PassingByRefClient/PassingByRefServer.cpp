...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalByteArray_AsParam_AsByRef(DelByteArrByRefAsCdeclCaller caller)
{
    BYTE arrSize = 0;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalSbyteArray_AsParam_AsByRef(DelSbyteArrByRefAsCdeclCaller caller)
{
    CHAR arrSize = 1;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalShortArray_AsParam_AsByRef(DelShortArrByRefAsCdeclCaller caller)
{
    SHORT arrSize = -1;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalShortArrayReturnNegativeSize_AsParam_AsByRef(DelShortArrByRefAsCdeclCaller caller)
{
    SHORT arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUshortArray_AsParam_AsByRef(DelUshortArrByRefAsCdeclCaller caller)
{
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalInt32Array_AsParam_AsByRef(DelInt32ArrByRefAsCdeclCaller caller)
{
    LONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUint32Array_AsParam_AsByRef(DelUint32ArrByRefAsCdeclCaller caller)
{
    ULONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalLongArray_AsParam_AsByRef(DelLongArrByRefAsCdeclCaller caller)
{
    LONGLONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUlongArray_AsParam_AsByRef(DelUlongArrByRefAsCdeclCaller caller)
{
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalStringArray_AsParam_AsByRef(DelStringArrByRefAsCdeclCaller caller)
{
    LONG arrSize = 10;
