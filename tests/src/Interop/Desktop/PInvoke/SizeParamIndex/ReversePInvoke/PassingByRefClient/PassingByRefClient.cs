...
public class ReversePInvoke_MashalArrayByRef_AsManaged
{
    ...
    [DllImport("ReversePInvoke_PassingByRefServer", CallingConvention = CallingConvention.Cdecl)]
    ...
    public static void RunTestByRef()
    {
        ...
        try
        {
            if (!DoCallBack_MarshalByteArray_AsParam_AsByRef(new DelByteArrByRefAsCdeclCaller(TestMethodForByteArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalByteArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalSbyteArray_AsParam_AsByRef(new DelSbyteArrByRefAsCdeclCaller(TestMethodForSbyteArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalSbyteArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalShortArray_AsParam_AsByRef(new DelShortArrByRefAsCdeclCaller(TestMethodForShortArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalShortArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalShortArrayReturnNegativeSize_AsParam_AsByRef(new DelShortArrByRefAsCdeclCaller(TestMethodForShortArrayReturnNegativeSize_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalShortArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
        ...
        try
        {
            if (!DoCallBack_MarshalUshortArray_AsParam_AsByRef(new DelUshortArrByRefAsCdeclCaller(TestMethodForUshortArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUshortArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalInt32Array_AsParam_AsByRef(new DelInt32ArrByRefAsCdeclCaller(TestMethodForInt32Array_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalInt32Array_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalUint32Array_AsParam_AsByRef(new DelUint32ArrByRefAsCdeclCaller(TestMethodForUint32Array_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUint32Array_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalLongArray_AsParam_AsByRef(new DelLongArrByRefAsCdeclCaller(TestMethodForLongArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalLongArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalUlongArray_AsParam_AsByRef(new DelUlongArrByRefAsCdeclCaller(TestMethodForUlongArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUlongArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalStringArray_AsParam_AsByRef(new DelStringArrByRefAsCdeclCaller(TestMethodForStringArray_AsReversePInvokeByRef_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalStringArray_AsReversePInvokeByRef_AsCdecl Failed!");
            }
            else
            {
