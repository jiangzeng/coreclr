...
public class ReversePInvoke_MashalArrayByOut_AsManaged
{
    ...
    [DllImport("ReversePInvoke_PassingByOutServer", CallingConvention = CallingConvention.Cdecl)]
    ...
    public static void RunTestByOut()
    {
        ...
        try
        {
            if (!DoCallBack_MarshalByteArray_AsParam_AsByOut(new DelByteArrByOutAsCdeclCaller(TestMethodForByteArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalByteArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalSbyteArray_AsParam_AsByOut(new DelSbyteArrByOutAsCdeclCaller(TestMethodForSbyteArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalSbyteArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalShortArray_AsParam_AsByOut(new DelShortArrByOutAsCdeclCaller(TestMethodForShortArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
        ...
        try
        {
            if (!DoCallBack_MarshalShortArrayReturnNegativeSize_AsParam_AsByOut(new DelShortArrByOutAsCdeclCaller(TestMethodForShortArrayReturnNegativeSize_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalShortArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
        ...
        try
        {
            if (!DoCallBack_MarshalUshortArray_AsParam_AsByOut(new DelUshortArrByOutAsCdeclCaller(TestMethodForUshortArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUshortArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalInt32Array_AsParam_AsByOut(new DelInt32ArrByOutAsCdeclCaller(TestMethodForInt32Array_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalInt32Array_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalUint32Array_AsParam_AsByOut(new DelUint32ArrByOutAsCdeclCaller(TestMethodForUint32Array_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUint32Array_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalLongArray_AsParam_AsByOut(new DelLongArrByOutAsCdeclCaller(TestMethodForLongArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalLongArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalUlongArray_AsParam_AsByOut(new DelUlongArrByOutAsCdeclCaller(TestMethodForUlongArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalUlongArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
        ...
        try
        {
            if (!DoCallBack_MarshalStringArray_AsParam_AsByOut(new DelStringArrByOutAsCdeclCaller(TestMethodForStringArray_AsReversePInvokeByOut_AsCdecl)))
            {
                failures++;
                Console.WriteLine("\t\tMarshalStringArray_AsReversePInvokeByOut_AsCdecl Failed!");
            }
            else
            {
