// PInvokeServer_AsUnmanaged.cpp : Defines the entry point for the DLL application.
//
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalByteArray_AsParam_AsByOut(DelByteArrByOutAsCdeclCaller caller)
{
    BYTE arrSize = 0;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalSbyteArray_AsParam_AsByOut(DelSbyteArrByOutAsCdeclCaller caller)
{
    CHAR arrSize = 1;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalShortArray_AsParam_AsByOut(DelShortArrByOutAsCdeclCaller caller)
{
    SHORT arrSize = -1;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalShortArrayReturnNegativeSize_AsParam_AsByOut(DelShortArrByOutAsCdeclCaller caller)
{
    SHORT arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUshortArray_AsParam_AsByOut(DelUshortArrByOutAsCdeclCaller caller)
{
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalInt32Array_AsParam_AsByOut(DelInt32ArrByOutAsCdeclCaller caller)
{
    LONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUint32Array_AsParam_AsByOut(DelUint32ArrByOutAsCdeclCaller caller)
{
    ULONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalLongArray_AsParam_AsByOut(DelLongArrByOutAsCdeclCaller caller)
{
    LONGLONG arrSize = 10;
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalUlongArray_AsParam_AsByOut(DelUlongArrByOutAsCdeclCaller caller)
{
...
extern "C" __declspec(dllexport) BOOL __cdecl DoCallBack_MarshalStringArray_AsParam_AsByOut(DelStringArrByOutAsCdeclCaller caller)
{
    LONG arrSize = 10;
