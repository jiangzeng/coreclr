...
public class ComVisibleServer
{
    ...
    private static void RunComVisibleTests()
    {
        ...
        TestHelper.Assert(Helpers.S_OK, CCWTest_InterfaceWithoutVisible((object)visibleBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(4, fooSuccessVal, "COM method didn't return the expected value.");
        ...
        TestHelper.Assert(Helpers.S_OK, CCWTest_InterfaceNotVisibleNoGuid((object)visibleBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(16, fooSuccessVal, "COM method didn't return the expected value.");
#endif //BUG1044264
        ...
        TestHelper.BeginSubScenario("CCWTest_InterfaceWithoutVisible");
        TestHelper.Assert(Helpers.S_OK, CCWTest_InterfaceWithoutVisible((object)visibleFalseBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(123, fooSuccessVal, "COM method didn't return the expected value.");
        ...
        TestHelper.BeginSubScenario("CCWTest_InterfaceWithoutVisible");
        TestHelper.Assert(Helpers.S_OK, CCWTest_InterfaceWithoutVisible((object)withoutVisibleBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(133, fooSuccessVal, "COM method didn't return the expected value.");
        ...
        TestHelper.Assert(Helpers.S_OK, CCWTest_NestedInterfaceWithoutVisible((object)visibleNestedBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(13, fooSuccessVal, "COM method didn't return the expected value.");
        ...
        TestHelper.BeginSubScenario("CCWTest_NestedInterfaceWithoutVisible");
        TestHelper.Assert(Helpers.S_OK, CCWTest_NestedInterfaceWithoutVisible((object)visibleFalseNestedBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(23, fooSuccessVal, "COM method didn't return the expected value.");
        ...
        TestHelper.BeginSubScenario("CCWTest_NestedInterfaceWithoutVisible");
        TestHelper.Assert(Helpers.S_OK, CCWTest_NestedInterfaceWithoutVisible((object)withoutVisibleNestedBaseClass, out fooSuccessVal), "COM method thrown an unexpected exception.");
        TestHelper.Assert(33, fooSuccessVal, "COM method didn't return the expected value.");
