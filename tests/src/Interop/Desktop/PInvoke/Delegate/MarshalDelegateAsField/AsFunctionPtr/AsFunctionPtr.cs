...
class Test
{
    ...
    static int Main()
    {
        ...
        TestHelper.Assert(TakeDelegateAsFieldInStruct_Seq(s1), "Delegate marshaled as field in struct with Sequential.");
        ...
        TestHelper.Assert(TakeDelegateAsFieldInClass_Exp(c4), "Delegate marshaled as field in class with Sequential.");
