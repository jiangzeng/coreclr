...
extern "C" __declspec(dllexport) int __stdcall CommonMethod()
{
...
extern "C" __declspec(dllexport) BOOL __stdcall TakeDelegateAsFieldInStruct_Seq(Struct1_FuncPtrAsField1_Seq sfs)
{
...
extern "C" __declspec(dllexport) BOOL __stdcall TakeDelegateAsFieldInStruct_Exp(Struct1_FuncPtrAsField2_Exp sfe)
{
...
extern "C" __declspec(dllexport) BOOL __stdcall TakeDelegateAsFieldInClass_Seq(Class1_FuncPtrAsField3_Seq *cfs)
{
...
extern "C" __declspec(dllexport) BOOL __stdcall TakeDelegateAsFieldInClass_Exp(Class1_FuncPtrAsField4_Exp *cfe)
{
...
extern "C" __declspec(dllexport) BOOL __stdcall Take_DelegatePtrAsFieldInStruct_Seq(Struct3_InterfacePtrAsField1_Seq sis)
{
    HRESULT hr;
...
extern "C" __declspec(dllexport) BOOL __stdcall Take_DelegatePtrAsFieldInStruct_Exp(Struct3_InterfacePtrAsField2_Exp sie)
{
    HRESULT hr;
...
extern "C" __declspec(dllexport) BOOL __stdcall Take_DelegatePtrAsFieldInClass_Seq(Class3_InterfacePtrAsField3_Seq *cis)
{
    HRESULT hr;
...
extern "C" __declspec(dllexport) BOOL __stdcall Take_DelegatePtrAsFieldInClass_Exp(Class3_InterfacePtrAsField4_Exp *cie)
{
    HRESULT hr;
