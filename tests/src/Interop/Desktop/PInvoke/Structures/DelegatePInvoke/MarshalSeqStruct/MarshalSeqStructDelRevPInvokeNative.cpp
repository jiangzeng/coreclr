#include "MarshalSeqStructDelRevPInvokeNative.h"

const char* NativeStr = "Native";
const int size = strlen(NativeStr);
...
extern "C"  BOOL _cdecl MarshalStructComplexStructByRef_Cdecl(ComplexStruct * pcs)
{                       
    //Check the Input    
    if((321 != pcs->i)||(!pcs->b)||(0 != strcmp(pcs->str,"Managed"))||(123 != pcs->type.idata)||(0x120000 != (int)pcs->type.udata.ptrdata))
    {

        printf("The parameter for MarshalRefStruct_Cdecl is wrong\n");
        printf("ComplexStruct:%d:%d,%s,%d,%d\n",pcs->i,pcs->b,pcs->str,pcs->type.idata,pcs->type.udata.ptrdata);
        return FALSE;
    }
    CoTaskMemFree((LPVOID)pcs->str);

    const char* lNativeStr = "Native";
    const int lsize = strlen(lNativeStr);
    char * pstr = (char*)CoTaskMemAlloc((lsize + 1) * sizeof(char));
...
extern "C"  BOOL __stdcall MarshalStructComplexStructByRef_StdCall(ComplexStruct * pcs)
{
    //Check the input
    if((321 != pcs->i)||(!pcs->b)||(0 != strcmp(pcs->str,"Managed"))||(123 != pcs->type.idata)||(0x120000 != (int)pcs->type.udata.ptrdata))
    {
    ...
    const char* lNativeStr = "Native";
    const int lsize = strlen(lNativeStr);
    char * pstr = (char*)CoTaskMemAlloc(lsize + 1);
    memset(pstr,0,lsize+1);
    strncpy_s(pstr,lsize+1,lNativeStr,lsize);
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructComplexStructByRef_Cdecl(ComplexStructByRefCdeclCaller caller)
{
    const char* lNativeStr = "Native";
    const int lsize = strlen(lNativeStr);
    ...
    if((321 != cs.i)||(!cs.b)||(0 != strcmp(cs.str,"Managed"))||(123 != cs.type.idata)||(0x120000 != (int)cs.type.udata.ptrdata))
    {
        printf("The parameter for DoCallBack_MarshalRefStruct_Cdecl is wrong\n");
        return FALSE;
    }
    CoTaskMemFree((LPVOID)cs.str);
    return TRUE;
}

typedef BOOL (__stdcall *ComplexStructByRefStdCallCaller)(ComplexStruct* pcs);
extern "C"  BOOL __stdcall DoCallBack_MarshalStructComplexStructByRef_StdCall(ComplexStructByRefStdCallCaller caller)
{
    const char* lNativeStr = "Native";
    const int lsize = strlen(lNativeStr);
...
extern "C" ComplexStructDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructComplexStructByRef_Cdecl_FuncPtr()
{
...
extern "C" ComplexStructDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructComplexStructByRef_StdCall_FuncPtr()
{
    return MarshalStructComplexStructByRef_StdCall;
}

//Passby value
extern "C"  BOOL _cdecl MarshalStructComplexStructByVal_Cdecl(ComplexStruct cs)
{
    //Check the Input    
    if((321 != cs.i)||(!cs.b)||(0 != strcmp(cs.str,"Managed"))||(123 != cs.type.idata)||(0x120000 != (int)cs.type.udata.ptrdata))
    {
        ...
        printf("ComplexStruct:%d:%d,%s,%d,%d\n",cs.i,cs.b,cs.str,cs.type.idata,cs.type.udata.ptrdata);
        return FALSE;
    }
...
extern "C" BOOL __stdcall MarshalStructComplexStructByVal_StdCall(ComplexStruct cs)
{
    //Check the input
    if((321 != cs.i)||(!cs.b)||(0 != strcmp(cs.str,"Managed"))||(123 != cs.type.idata)||(0x120000 != (int)cs.type.udata.ptrdata))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructComplexStructByVal_Cdecl(ComplexStructByValCdeclCaller caller)
{
    //Init
    ComplexStruct cs;
    cs.i = 9999;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructComplexStructByVal_StdCall(ComplexStructByValStdCallCaller caller)
{
    ComplexStruct cs;
    cs.i = 9999;
    cs.b = false;
...
extern "C" ComplexStructDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructComplexStructByVal_Cdecl_FuncPtr()
{
...
extern "C" ComplexStructDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructComplexStructByVal_StdCall_FuncPtr()
{
    return MarshalStructComplexStructByVal_StdCall;
}

///////////////////////////////////////////Methods for InnerSequential struct////////////////////////////////////////////////////
extern "C" BOOL _cdecl MarshalStructInnerSequentialByRef_Cdecl(InnerSequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructInnerSequentialByRef_StdCall(InnerSequential* argstr)
{
    if(!IsCorrectInnerSequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructInnerSequentialByRef_Cdecl(InnerSequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructInnerSequentialByRef_StdCall(InnerSequentialByRefStdCallCaller caller)
{
    //Init
    InnerSequential argstr;
    argstr.f1 = 77;
...
extern "C" InnerSequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructInnerSequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" InnerSequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructInnerSequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructInnerSequentialByVal_Cdecl(InnerSequential argstr)
{
    //Check the Input    
    if(!IsCorrectInnerSequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructInnerSequentialByVal_StdCall(InnerSequential argstr)
{
    //Check the Input    
    if(!IsCorrectInnerSequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructInnerSequentialByVal_Cdecl(InnerSequentialByValCdeclCaller caller)
{
    //Init
    InnerSequential argstr;
    argstr.f1 = 77;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructInnerSequentialByVal_StdCall(InnerSequentialByValStdCallCaller caller)
{
    //Init
    InnerSequential argstr;
    argstr.f1 = 77;
...
extern "C" InnerSequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructInnerSequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" InnerSequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructInnerSequentialByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructInnerArraySequentialByRef_Cdecl(InnerArraySequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructInnerArraySequentialByRef_StdCall(InnerArraySequential* argstr)
{
    if(!IsCorrectInnerArraySequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructInnerArraySequentialByRef_Cdecl(InnerArraySequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructInnerArraySequentialByRef_StdCall(InnerArraySequentialByRefStdCallCaller caller)
{
    //Init
    InnerArraySequential argstr;
    for(int i = 0;i<NumArrElements;i++)
...
extern "C" InnerArraySequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructInnerArraySequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" InnerArraySequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructInnerArraySequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructInnerArraySequentialByVal_Cdecl(InnerArraySequential argstr)
{
    //Check the Input    
    if(!IsCorrectInnerArraySequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructInnerArraySequentialByVal_StdCall(InnerArraySequential argstr)
{
    //Check the Input    
    if(!IsCorrectInnerArraySequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructInnerArraySequentialByVal_Cdecl(InnerArraySequentialByValCdeclCaller caller)
{
    //Init
    InnerArraySequential argstr;
    for(int i = 0;i<NumArrElements;i++)
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructInnerArraySequentialByVal_StdCall(InnerArraySequentialByValStdCallCaller caller)
{
    //Init
    InnerArraySequential argstr;
    for(int i = 0;i<NumArrElements;i++)
...
extern "C" InnerArraySequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructInnerArraySequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" InnerArraySequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructInnerArraySequentialByVal_StdCall_FuncPtr()
{
    return MarshalStructInnerArraySequentialByVal_StdCall;
}

///////////////////////////////////////////Methods for CharSetAnsiSequential struct////////////////////////////////////////////////////
extern "C" BOOL _cdecl MarshalStructCharSetAnsiSequentialByRef_Cdecl(CharSetAnsiSequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructCharSetAnsiSequentialByRef_StdCall(CharSetAnsiSequential* argstr)
{
    if(!IsCorrectCharSetAnsiSequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructCharSetAnsiSequentialByRef_Cdecl(CharSetAnsiSequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructCharSetAnsiSequentialByRef_StdCall(CharSetAnsiSequentialByRefStdCallCaller caller)
{
    //Init
    CharSetAnsiSequential argstr;
...
extern "C" CharSetAnsiSequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructCharSetAnsiSequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" CharSetAnsiSequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructCharSetAnsiSequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructCharSetAnsiSequentialByVal_Cdecl(CharSetAnsiSequential argstr)
{
    //Check the Input    
    if(!IsCorrectCharSetAnsiSequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructCharSetAnsiSequentialByVal_StdCall(CharSetAnsiSequential argstr)
{
    //Check the Input    
    if(!IsCorrectCharSetAnsiSequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructCharSetAnsiSequentialByVal_Cdecl(CharSetAnsiSequentialByValCdeclCaller caller)
{
    //Init
    CharSetAnsiSequential argstr;
    char* strSource = "change string";
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructCharSetAnsiSequentialByVal_StdCall(CharSetAnsiSequentialByValStdCallCaller caller)
{
    //Init
    CharSetAnsiSequential argstr;
    char* strSource = "change string";
...
extern "C" CharSetAnsiSequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructCharSetAnsiSequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" CharSetAnsiSequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructCharSetAnsiSequentialByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructCharSetUnicodeSequentialByRef_Cdecl(CharSetUnicodeSequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructCharSetUnicodeSequentialByRef_StdCall(CharSetUnicodeSequential* argstr)
{
    if(!IsCorrectCharSetUnicodeSequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructCharSetUnicodeSequentialByRef_Cdecl(CharSetUnicodeSequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructCharSetUnicodeSequentialByRef_StdCall(CharSetUnicodeSequentialByRefStdCallCaller caller)
{
    //Init
    CharSetUnicodeSequential argstr;
...
extern "C" CharSetUnicodeSequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructCharSetUnicodeSequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" CharSetUnicodeSequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructCharSetUnicodeSequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructCharSetUnicodeSequentialByVal_Cdecl(CharSetUnicodeSequential argstr)
{
    //Check the Input    
    if(!IsCorrectCharSetUnicodeSequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructCharSetUnicodeSequentialByVal_StdCall(CharSetUnicodeSequential argstr)
{
    //Check the Input    
    if(!IsCorrectCharSetUnicodeSequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructCharSetUnicodeSequentialByVal_Cdecl(CharSetUnicodeSequentialByValCdeclCaller caller)
{
    //Init
    CharSetUnicodeSequential argstr;
    WCHAR* strSource = (WCHAR*)(L"change string");
    ...
    //Verify the value unchanged
    if(0 != wcscmp(const_cast<WCHAR*>(argstr.f1), const_cast<WCHAR*>(L"change string")) || argstr.f2 != L'n')
    {
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructCharSetUnicodeSequentialByVal_StdCall(CharSetUnicodeSequentialByValStdCallCaller caller)
{
    //Init
    CharSetUnicodeSequential argstr;
    WCHAR* strSource = (WCHAR*)(L"change string");
...
extern "C" CharSetUnicodeSequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructCharSetUnicodeSequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" CharSetUnicodeSequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructCharSetUnicodeSequentialByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructNumberSequentialByRef_Cdecl(NumberSequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructNumberSequentialByRef_StdCall(NumberSequential* argstr)
{
    if(!IsCorrectNumberSequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructNumberSequentialByRef_Cdecl(NumberSequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructNumberSequentialByRef_StdCall(NumberSequentialByRefStdCallCaller caller)
{
    //Init
    NumberSequential argstr;
...
extern "C" NumberSequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructNumberSequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" NumberSequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructNumberSequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructNumberSequentialByVal_Cdecl(NumberSequential argstr)
{
    //Check the Input    
    if(!IsCorrectNumberSequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructNumberSequentialByVal_StdCall(NumberSequential argstr)
{
    //Check the Input    
    if(!IsCorrectNumberSequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructNumberSequentialByVal_Cdecl(NumberSequentialByValCdeclCaller caller)
{
    //Init
    NumberSequential argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructNumberSequentialByVal_StdCall(NumberSequentialByValStdCallCaller caller)
{
    //Init
    NumberSequential argstr;
...
extern "C" NumberSequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructNumberSequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" NumberSequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructNumberSequentialByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructS3ByRef_Cdecl(S3* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructS3ByRef_StdCall(S3* argstr)
{
    if(!IsCorrectS3(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS3ByRef_Cdecl(S3ByRefCdeclCaller caller)
{
    //Init
    S3 argstr;
    ...
    LPCSTR temp = (LPCSTR)CoTaskMemAlloc(sizeof(char)*len);
    if(temp != NULL)
    {
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS3ByRef_StdCall(S3ByRefStdCallCaller caller)
{
    //Init
    S3 argstr;
...
extern "C" S3DelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructS3ByRef_Cdecl_FuncPtr()
{
    return MarshalStructS3ByRef_Cdecl;            
}

typedef BOOL (__stdcall *S3DelegatePInvokeByRefStdCallCaller)(S3* pcs);
extern "C" S3DelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructS3ByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructS3ByVal_Cdecl(S3 argstr)
{
    //Check the Input    
    if(!IsCorrectS3(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructS3ByVal_StdCall(S3 argstr)
{
    //Check the Input    
    if(!IsCorrectS3(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS3ByVal_Cdecl(S3ByValCdeclCaller caller)
{
    //Init
    S3 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS3ByVal_StdCall(S3ByValStdCallCaller caller)
{
    //Init
    S3 argstr;
...
extern "C" S3DelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructS3ByVal_Cdecl_FuncPtr()
{
    return MarshalStructS3ByVal_Cdecl;
}

typedef BOOL (__stdcall *S3DelegatePInvokeByValStdCallCaller)(S3 cs);
extern "C" S3DelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructS3ByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructS5ByRef_Cdecl(S5* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructS5ByRef_StdCall(S5* argstr)
{
    if(!IsCorrectS5(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS5ByRef_Cdecl(S5ByRefCdeclCaller caller)
{
    //Init
    S5 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS5ByRef_StdCall(S5ByRefStdCallCaller caller)
{
    //Init
    S5 argstr;
...
extern "C" S5DelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructS5ByRef_Cdecl_FuncPtr()
{
    return MarshalStructS5ByRef_Cdecl;            
}

typedef BOOL (__stdcall *S5DelegatePInvokeByRefStdCallCaller)(S5* pcs);
extern "C" S5DelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructS5ByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructS5ByVal_Cdecl(S5 argstr)
{
    //Check the Input    
    if(!IsCorrectS5(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructS5ByVal_StdCall(S5 argstr)
{
    //Check the Input    
    if(!IsCorrectS5(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS5ByVal_Cdecl(S5ByValCdeclCaller caller)
{
    //Init
    S5 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS5ByVal_StdCall(S5ByValStdCallCaller caller)
{
    //Init
    S5 argstr;
...
extern "C" S5DelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructS5ByVal_Cdecl_FuncPtr()
{
    return MarshalStructS5ByVal_Cdecl;
}

typedef BOOL (__stdcall *S5DelegatePInvokeByValStdCallCaller)(S5 cs);
extern "C" S5DelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructS5ByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructStringStructSequentialAnsiByRef_Cdecl(StringStructSequentialAnsi* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructStringStructSequentialAnsiByRef_StdCall(StringStructSequentialAnsi* argstr)
{
    if(!IsCorrectStringStructSequentialAnsi(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructStringStructSequentialAnsiByRef_Cdecl(StringStructSequentialAnsiByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructStringStructSequentialAnsiByRef_StdCall(StringStructSequentialAnsiByRefStdCallCaller caller)
{
    //Init
    StringStructSequentialAnsi argstr;
...
extern "C" StringStructSequentialAnsiDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructStringStructSequentialAnsiByRef_Cdecl_FuncPtr()
{
...
extern "C" StringStructSequentialAnsiDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructStringStructSequentialAnsiByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructStringStructSequentialAnsiByVal_Cdecl(StringStructSequentialAnsi argstr)
{
    //Check the Input    
    if(!IsCorrectStringStructSequentialAnsi(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructStringStructSequentialAnsiByVal_StdCall(StringStructSequentialAnsi argstr)
{
    //Check the Input    
    if(!IsCorrectStringStructSequentialAnsi(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructStringStructSequentialAnsiByVal_Cdecl(StringStructSequentialAnsiByValCdeclCaller caller)
{
    //Init
    StringStructSequentialAnsi argstr;
    char* newFirst = (char*)CoTaskMemAlloc(sizeof(char)*513);
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructStringStructSequentialAnsiByVal_StdCall(StringStructSequentialAnsiByValStdCallCaller caller)
{
    //Init
    StringStructSequentialAnsi argstr;
    char* newFirst = (char*)CoTaskMemAlloc(sizeof(char)*513);
...
extern "C" StringStructSequentialAnsiDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructStringStructSequentialAnsiByVal_Cdecl_FuncPtr()
{
...
extern "C" StringStructSequentialAnsiDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructStringStructSequentialAnsiByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructStringStructSequentialUnicodeByRef_Cdecl(StringStructSequentialUnicode* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructStringStructSequentialUnicodeByRef_StdCall(StringStructSequentialUnicode* argstr)
{
    if(!IsCorrectStringStructSequentialUnicode(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructStringStructSequentialUnicodeByRef_Cdecl(StringStructSequentialUnicodeByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructStringStructSequentialUnicodeByRef_StdCall(StringStructSequentialUnicodeByRefStdCallCaller caller)
{
    //Init
    StringStructSequentialUnicode argstr;
...
extern "C" StringStructSequentialUnicodeDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructStringStructSequentialUnicodeByRef_Cdecl_FuncPtr()
{
...
extern "C" StringStructSequentialUnicodeDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructStringStructSequentialUnicodeByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructStringStructSequentialUnicodeByVal_Cdecl(StringStructSequentialUnicode argstr)
{
    //Check the Input    
    if(!IsCorrectStringStructSequentialUnicode(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructStringStructSequentialUnicodeByVal_StdCall(StringStructSequentialUnicode argstr)
{
    //Check the Input    
    if(!IsCorrectStringStructSequentialUnicode(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructStringStructSequentialUnicodeByVal_Cdecl(StringStructSequentialUnicodeByValCdeclCaller caller)
{
    //Init
    StringStructSequentialUnicode argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructStringStructSequentialUnicodeByVal_StdCall(StringStructSequentialUnicodeByValStdCallCaller caller)
{
    //Init
    StringStructSequentialUnicode argstr;
...
extern "C" StringStructSequentialUnicodeDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructStringStructSequentialUnicodeByVal_Cdecl_FuncPtr()
{
...
extern "C" StringStructSequentialUnicodeDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructStringStructSequentialUnicodeByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructS8ByRef_Cdecl(S8* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructS8ByRef_StdCall(S8* argstr)
{
    if(!IsCorrectS8(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS8ByRef_Cdecl(S8ByRefCdeclCaller caller)
{
    //Init
    S8 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS8ByRef_StdCall(S8ByRefStdCallCaller caller)
{
    //Init
    S8 argstr;
...
extern "C" S8DelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructS8ByRef_Cdecl_FuncPtr()
{
    return MarshalStructS8ByRef_Cdecl;            
}

typedef BOOL (__stdcall *S8DelegatePInvokeByRefStdCallCaller)(S8* pcs);
extern "C" S8DelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructS8ByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructS8ByVal_Cdecl(S8 argstr)
{
    //Check the Input    
    if(!IsCorrectS8(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructS8ByVal_StdCall(S8 argstr)
{
    //Check the Input    
    if(!IsCorrectS8(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS8ByVal_Cdecl(S8ByValCdeclCaller caller)
{
    //Init
    S8 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS8ByVal_StdCall(S8ByValStdCallCaller caller)
{
    //Init
    S8 argstr;
...
extern "C" S8DelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructS8ByVal_Cdecl_FuncPtr()
{
    return MarshalStructS8ByVal_Cdecl;
}

typedef BOOL (__stdcall *S8DelegatePInvokeByValStdCallCaller)(S8 cs);
extern "C" S8DelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructS8ByVal_StdCall_FuncPtr()
{
...
extern "C" BOOL _cdecl MarshalStructS9ByRef_Cdecl(S9* argstr)
{
    if(argstr->i32 != 128 ||
...
extern "C" BOOL __stdcall MarshalStructS9ByRef_StdCall(S9* argstr)
{
    if(argstr->i32 != 128 ||
        argstr->myDelegate1 == NULL)
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS9ByRef_Cdecl(S9ByRefCdeclCaller caller)
{
    //Init
    S9 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS9ByRef_StdCall(S9ByRefStdCallCaller caller)
{
    //Init
    S9 argstr;
...
extern "C" S9DelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructS9ByRef_Cdecl_FuncPtr()
{
    return MarshalStructS9ByRef_Cdecl;            
}

typedef BOOL (__stdcall *S9DelegatePInvokeByRefStdCallCaller)(S9* pcs);
extern "C" S9DelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructS9ByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructS9ByVal_Cdecl(S9 argstr)
{
    //Check the Input    
    if(argstr.i32 != 128 ||
        argstr.myDelegate1 == NULL)
...
extern "C" BOOL __stdcall MarshalStructS9ByVal_StdCall(S9 argstr)
{
    //Check the Input    
    if(argstr.i32 != 128 ||
        argstr.myDelegate1 == NULL)
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS9ByVal_Cdecl(S9ByValCdeclCaller caller)
{
    //Init
    S9 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS9ByVal_StdCall(S9ByValStdCallCaller caller)
{
    //Init
    S9 argstr;
...
extern "C" S9DelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructS9ByVal_Cdecl_FuncPtr()
{
    return MarshalStructS9ByVal_Cdecl;
}

typedef BOOL (__stdcall *S9DelegatePInvokeByValStdCallCaller)(S9 cs);
extern "C" S9DelegatePInvokeByValStdCallCaller _cdecl Get_MarshalStructS9ByVal_StdCall_FuncPtr()
{
    return MarshalStructS9ByVal_StdCall;
}

///////////////////////////////////////////Methods for IncludeOuterIntergerStructSequential struct////////////////////////////////////////////////////
extern "C" BOOL _cdecl MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl(IncludeOuterIntergerStructSequential* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall(IncludeOuterIntergerStructSequential* argstr)
{
    if(!IsCorrectIncludeOuterIntergerStructSequential(argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl(IncludeOuterIntergerStructSequentialByRefCdeclCaller caller)
{
    //Init
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall(IncludeOuterIntergerStructSequentialByRefStdCallCaller caller)
{
    //Init
    IncludeOuterIntergerStructSequential argstr;
...
extern "C" IncludeOuterIntergerStructSequentialDelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructIncludeOuterIntergerStructSequentialByRef_Cdecl_FuncPtr()
{
...
extern "C" IncludeOuterIntergerStructSequentialDelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructIncludeOuterIntergerStructSequentialByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl(IncludeOuterIntergerStructSequential argstr)
{
    //Check the Input    
    if(!IsCorrectIncludeOuterIntergerStructSequential(&argstr))
    {
...
extern "C" BOOL __stdcall MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall(IncludeOuterIntergerStructSequential argstr)
{
    //Check the Input    
    if(!IsCorrectIncludeOuterIntergerStructSequential(&argstr))
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl(IncludeOuterIntergerStructSequentialByValCdeclCaller caller)
{
    //Init
    IncludeOuterIntergerStructSequential argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall(IncludeOuterIntergerStructSequentialByValStdCallCaller caller)
{
    //Init
    IncludeOuterIntergerStructSequential argstr;
...
extern "C" IncludeOuterIntergerStructSequentialDelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructIncludeOuterIntergerStructSequentialByVal_Cdecl_FuncPtr()
{
...
extern "C" IncludeOuterIntergerStructSequentialDelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall_FuncPtr()
{
    return MarshalStructIncludeOuterIntergerStructSequentialByVal_StdCall;
}

///////////////////////////////////////////Methods for S11 struct////////////////////////////////////////////////////
extern "C" BOOL _cdecl MarshalStructS11ByRef_Cdecl(S11* argstr)
{
...
extern "C" BOOL __stdcall MarshalStructS11ByRef_StdCall(S11* argstr)
{
    if(argstr->i32 != (LPINT)(32) || argstr->i != 32)
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS11ByRef_Cdecl(S11ByRefCdeclCaller caller)
{
    //Init
    S11 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS11ByRef_StdCall(S11ByRefStdCallCaller caller)
{
    //Init
    S11 argstr;
...
extern "C" S11DelegatePInvokeByRefCdeclCaller _cdecl Get_MarshalStructS11ByRef_Cdecl_FuncPtr()
{
    return MarshalStructS11ByRef_Cdecl;            
}

typedef BOOL (__stdcall *S11DelegatePInvokeByRefStdCallCaller)(S11* pcs);
extern "C" S11DelegatePInvokeByRefStdCallCaller __stdcall Get_MarshalStructS11ByRef_StdCall_FuncPtr()
{
...
//Passby value
extern "C"  BOOL _cdecl MarshalStructS11ByVal_Cdecl(S11 argstr)
{
    //Check the Input    
    if(argstr.i32 != (LPINT)(32) || argstr.i != 32)
    {
...
extern "C" BOOL __stdcall MarshalStructS11ByVal_StdCall(S11 argstr)
{
    //Check the Input    
    if(argstr.i32 != (LPINT)(32) || argstr.i != 32)
    {
...
extern "C"  BOOL _cdecl DoCallBack_MarshalStructS11ByVal_Cdecl(S11ByValCdeclCaller caller)
{
    //Init
    S11 argstr;
...
extern "C"  BOOL __stdcall DoCallBack_MarshalStructS11ByVal_StdCall(S11ByValStdCallCaller caller)
{
    //Init
    S11 argstr;
...
extern "C" S11DelegatePInvokeByValCdeclCaller _cdecl Get_MarshalStructS11ByVal_Cdecl_FuncPtr()
{
    return MarshalStructS11ByVal_Cdecl;
}

typedef BOOL (__stdcall *S11DelegatePInvokeByValStdCallCaller)(S11 cs);
extern "C" S11DelegatePInvokeByValStdCallCaller __stdcall Get_MarshalStructS11ByVal_StdCall_FuncPtr()
{
