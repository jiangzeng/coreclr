...
class AsDefaultTest
{
    ...
    static int Main(string[] args)
    {
        try{
            ...
            Console.WriteLine("Scenario 2 : Delegate marshaled by ref with default attribute.");
            ...
            Console.WriteLine("Scenario 3 : Delegate marshaled by val with default attribute.");
            ...
            Assert.AreNotEqual(null, dele7, "The variable dele7 is null!");
