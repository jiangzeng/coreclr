...
class AsInterfaceTest
{
    ...
    static int Main()
    {
        try{
            ...
            Console.WriteLine("Scenario 2 : Delegate marshaled by ref with attribute [MarshalAs(MarshalAs(UnmanagedType.Interface)].");
            Dele dele2 = new Dele(CommonMethod1);
            dele2 += CommonMethod2;
            dele2 += CommonMethod3;
            Assert.IsTrue(Take_DelegatePtrByRefParam(ref dele2), "Take_DelegatePtrByRefParam");
            Assert.AreEqual(null, dele2, "dele2 should equal to null");

            Console.WriteLine("Scenario 3 : Delegate marshaled by val with attribute [In,MarshalAs(UnmanagedType.Interface)].");
            Dele dele3 = new Dele(CommonMethod1);
            dele3 += CommonMethod2;
            dele3 += CommonMethod3;
            Assert.IsTrue(Take_DelegatePtrByInValParam(dele3), "Take_DelegatePtrByInValParam");

            Console.WriteLine("Scenario 4 : Delegate marshaled by ref with attribute [In,MarshalAs(UnmanagedType.Interface)].");
            Dele dele4 = new Dele(CommonMethod1);
            dele4 += CommonMethod2;
            dele4 += CommonMethod3;
            Assert.IsTrue(Take_DelegatePtrByInRefParam(ref dele4), "Take_DelegatePtrByInRefParam");
            Assert.AreNotEqual(null, dele4, "dele4 does't set to null correctly.");

            Console.WriteLine("Scenario 5 : Delegate marshaled by val with attribute [Out,MarshalAs(UnmanagedType.Interface)].");
            Dele dele5 = new Dele(CommonMethod1);
            dele5 += CommonMethod2;
            dele5 += CommonMethod3;
            Assert.IsTrue(Take_DelegatePtrByOutValParam(dele5), "Take_DelegatePtrByOutValParam");
            Assert.AreNotEqual(null, dele5, "dele5 does't set to null correctly");

            Console.WriteLine("Scenario 6 : Delegate marshaled by ref with attribute [Out,MarshalAs(UnmanagedType.Interface)].");
            Dele dele6 = null;
            ...
            Console.WriteLine("Scenario 7 : Delegate marshaled by val with attribute [In,OutMarshalAs(UnmanagedType.Interface)].");
            Dele dele7 = new Dele(CommonMethod1);
            dele7 += CommonMethod2;
            dele7 += CommonMethod3;
            Assert.IsTrue(Take_DelegatePtrByInOutValParam(dele7), "Take_DelegatePtrByInOutValParam");

            Console.WriteLine("Scenario 8 : Delegate marshaled by ref with attribute [In,OutMarshalAs(MarshalAs(UnmanagedType.Interface)].");
            ...
            Console.WriteLine("Scenario 9 : return Delegate marshaled by val with attribute [return:MarshalAs(UnmanagedType.Interface)].");
